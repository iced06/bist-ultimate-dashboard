...
COUNTRY_MACRO_CONFIG = {
    "🇺🇸 US": {
        "m2": {"symbols": ["DX-Y.NYB", "UUP"], "label": "US Dollar Index (DXY)", "unit": "Index"},
        "employment": {"symbols": ["^TNX", "IEF"], "label": "US 10Y Yield Proxy", "unit": "Index"},
        "consumer_spending": {"symbols": ["^GSPC", "SPY"], "label": "S&P 500", "unit": "Index"},
        "pce_index": {"symbols": ["GC=F", "GLD"], "label": "Gold", "unit": "USD"},
        "inflation": {"symbols": ["CL=F", "USO"], "label": "WTI Crude", "unit": "USD"},
        "pmi": {"symbols": ["^VIX"], "label": "VIX Volatility Index", "unit": "Index"},
    },
    "🇩🇪 Germany": {
        "m2": {"symbols": ["^GDAXI", "EWG"], "label": "DAX / Germany Equity", "unit": "Index"},
        "employment": {"symbols": ["EWG"], "label": "Germany Risk Proxy", "unit": "Index"},
        "consumer_spending": {"symbols": ["EURUSD=X"], "label": "EUR/USD", "unit": "FX Rate"},
        "pce_index": {"symbols": ["GC=F", "GLD"], "label": "Gold", "unit": "USD"},
        "inflation": {"symbols": ["CL=F", "USO"], "label": "WTI Crude", "unit": "USD"},
        "pmi": {"symbols": ["FEZ"], "label": "EuroStoxx 50 ETF", "unit": "Index"},
    },
    "🇯🇵 Japan": {
        "m2": {"symbols": ["^N225", "EWJ"], "label": "Nikkei / Japan Equity", "unit": "Index"},
        "employment": {"symbols": ["EWJ"], "label": "Japan Risk Proxy", "unit": "Index"},
        "consumer_spending": {"symbols": ["JPY=X"], "label": "USD/JPY", "unit": "FX Rate"},
        "pce_index": {"symbols": ["GC=F", "GLD"], "label": "Gold", "unit": "USD"},
        "inflation": {"symbols": ["CL=F", "USO"], "label": "WTI Crude", "unit": "USD"},
        "pmi": {"symbols": ["DX-Y.NYB", "UUP"], "label": "Dollar Index", "unit": "Index"},
    },
    "🇨🇳 China": {
        "m2": {"symbols": ["MCHI", "FXI"], "label": "China Equity Proxy", "unit": "Index"},
        "employment": {"symbols": ["MCHI"], "label": "China Risk Proxy", "unit": "Index"},
        "consumer_spending": {"symbols": ["CNH=X"], "label": "USD/CNH", "unit": "FX Rate"},
        "pce_index": {"symbols": ["GC=F", "GLD"], "label": "Gold", "unit": "USD"},
        "inflation": {"symbols": ["CL=F", "USO"], "label": "WTI Crude", "unit": "USD"},
        "pmi": {"symbols": ["FXI"], "label": "China Large Cap ETF", "unit": "Index"},
    },
    "🇮🇳 India": {
        "m2": {"symbols": ["INDA", "EPI"], "label": "India Equity Proxy", "unit": "Index"},
        "employment": {"symbols": ["INDA"], "label": "India Risk Proxy", "unit": "Index"},
        "consumer_spending": {"symbols": ["INR=X"], "label": "USD/INR", "unit": "FX Rate"},
        "pce_index": {"symbols": ["GC=F", "GLD"], "label": "Gold", "unit": "USD"},
        "inflation": {"symbols": ["CL=F", "USO"], "label": "WTI Crude", "unit": "USD"},
        "pmi": {"symbols": ["EPI"], "label": "India Earnings ETF", "unit": "Index"},
    },
    "🇹🇷 Turkey": {
        "m2": {"symbols": ["XU100.IS", "TUR"], "label": "BIST 100 / TUR ETF", "unit": "Index"},
        "employment": {"symbols": ["TUR"], "label": "Turkey Risk Proxy", "unit": "Index"},
        "consumer_spending": {"symbols": ["TRY=X"], "label": "USD/TRY", "unit": "FX Rate"},
        "pce_index": {"symbols": ["XBANK.IS", "TUR"], "label": "Turkey Banking Proxy", "unit": "Index"},
        "inflation": {"symbols": ["CL=F", "USO"], "label": "WTI Crude", "unit": "USD"},
        "pmi": {"symbols": ["XUSIN.IS", "TUR"], "label": "Turkey Industry Proxy", "unit": "Index"},
    },
}
...
def build_global_liquidity_proxy(start_date="2015-01-01"):
    ...
    if spx is None or dxy is None or us10y is None:
        return None

    merged = pd.concat(
        [
            spx["value"].rename("spx"),
            dxy["value"].rename("dxy"),
            us10y["value"].rename("us10y"),
        ],
        axis=1,
        join="inner",
    ).dropna()
    ...
    spx_norm = (merged["spx"] / merged["spx"].iloc[0]) * 100
    dxy_norm = (merged["dxy"] / merged["dxy"].iloc[0]) * 100
    us10y_norm = (merged["us10y"] / merged["us10y"].iloc[0]) * 100
    liquidity = (spx_norm + (200 - dxy_norm) + (200 - us10y_norm)) / 3
...
def display_macro_analysis():
    ...
    st.caption("Yahoo Finance-based liquidity/risk dashboard and cross-market indicators")
    ...
    indicator_labels = {
        ...
        "pce_index": "PCE / CPI Index",
        "inflation": "Inflation",
        "pmi": "Manufacturing PMI / Confidence",
    }
    
    with st.spinner(f"Loading {country} indicators..."):
        indicator_data = {}
        for key, cfg in config.items():
            indicator_data[key] = fetch_market_series(cfg["symbols"], "2018-01-01")
    ...
    st.caption("Source: Yahoo Finance market symbols")
