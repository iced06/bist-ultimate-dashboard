...
KEY_ITEMS_BY_DESC = {
    ...
    "total_equity":        ("Total Equity",              ["toplam özkaynaklar", "toplam özkaynak", "özkaynaklar toplamı"]),
    "paid_in_capital":     ("Paid-in Capital",           ["ödenmiş sermaye", "çıkarılmış sermaye", "sermaye"]),
}
