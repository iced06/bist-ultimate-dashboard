...
# Uses Yahoo Finance API (via requests) — no extra libraries needed
# =============================================================================

# Yahoo Finance tickers for country-specific market proxies & economic indicators
COUNTRY_MACRO_CONFIG = {
    "🇺🇸 US": {
        "m2":                {"ticker": "^GSPC",    "label": "S&P 500 (M2 Liquidity Proxy)",     "unit": "Index",  "color": "#00bfff"},
        "employment":        {"ticker": "^VIX",     "label": "VIX (Employment Risk Proxy)",      "unit": "Index",  "color": "#28a745"},
        "consumer_spending": {"ticker": "XLY",      "label": "Consumer Discretionary ETF (XLY)", "unit": "Price $","color": "#fd7e14"},
        "pce_index":         {"ticker": "TIP",      "label": "TIPS ETF (Inflation Expectations)","unit": "Price $","color": "#dc3545"},
        "inflation":         {"ticker": "^TNX",     "label": "US 10Y Treasury Yield",            "unit": "Yield %","color": "#ff6b6b"},
        "pmi":               {"ticker": "XLI",      "label": "Industrial ETF (Manufacturing)",   "unit": "Price $","color": "#6f42c1"},
    },
    "🇩🇪 Germany": {
        "m2":                {"ticker": "^GDAXI",   "label": "DAX 40 (M2 Liquidity Proxy)",      "unit": "Index",  "color": "#00bfff"},
        "employment":        {"ticker": "EWG",      "label": "iShares Germany ETF",              "unit": "Price $","color": "#28a745"},
        "consumer_spending": {"ticker": "EXS1.DE",  "label": "Euro Stoxx Consumer",              "unit": "Price €","color": "#fd7e14"},
        "pce_index":         {"ticker": "IBCI.L",   "label": "EU Inflation Linked Bond ETF",     "unit": "Price",  "color": "#dc3545"},
        "inflation":         {"ticker": "^GDAXI",   "label": "DAX (Economic Activity)",          "unit": "Index",  "color": "#ff6b6b"},
        "pmi":               {"ticker": "EWG",      "label": "Germany Manufacturing Proxy",      "unit": "Price $","color": "#6f42c1"},
    },
    "🇯🇵 Japan": {
        "m2":                {"ticker": "^N225",    "label": "Nikkei 225 (M2 Liquidity Proxy)",  "unit": "Index",  "color": "#00bfff"},
        "employment":        {"ticker": "EWJ",      "label": "iShares Japan ETF",                "unit": "Price $","color": "#28a745"},
        "consumer_spending": {"ticker": "EWJ",      "label": "Japan Consumer Proxy",             "unit": "Price $","color": "#fd7e14"},
        "pce_index":         {"ticker": "^N225",    "label": "Nikkei (Inflation Proxy)",         "unit": "Index",  "color": "#dc3545"},
        "inflation":         {"ticker": "USDJPY=X", "label": "USD/JPY Exchange Rate",            "unit": "Rate",   "color": "#ff6b6b"},
        "pmi":               {"ticker": "EWJ",      "label": "Japan Manufacturing Proxy",        "unit": "Price $","color": "#6f42c1"},
    },
    "🇨🇳 China": {
        "m2":                {"ticker": "000001.SS","label": "Shanghai Composite (M2 Proxy)",    "unit": "Index",  "color": "#00bfff"},
        "employment":        {"ticker": "FXI",      "label": "iShares China ETF",                "unit": "Price $","color": "#28a745"},
        "consumer_spending": {"ticker": "MCHI",     "label": "MSCI China ETF",                   "unit": "Price $","color": "#fd7e14"},
        "pce_index":         {"ticker": "CNYUSD=X", "label": "CNY/USD Exchange Rate",            "unit": "Rate",   "color": "#dc3545"},
        "inflation":         {"ticker": "FXI",      "label": "China Economic Activity Proxy",    "unit": "Price $","color": "#ff6b6b"},
        "pmi":               {"ticker": "KWEB",     "label": "China Internet/Manufacturing",     "unit": "Price $","color": "#6f42c1"},
    },
    "🇮🇳 India": {
        "m2":                {"ticker": "^BSESN",   "label": "BSE Sensex (M2 Proxy)",            "unit": "Index",  "color": "#00bfff"},
        "employment":        {"ticker": "INDA",     "label": "iShares India ETF",                "unit": "Price $","color": "#28a745"},
        "consumer_spending": {"ticker": "INDA",     "label": "India Consumer Proxy",             "unit": "Price $","color": "#fd7e14"},
        "pce_index":         {"ticker": "INRUSD=X", "label": "INR/USD Exchange Rate",            "unit": "Rate",   "color": "#dc3545"},
        "inflation":         {"ticker": "^BSESN",   "label": "Sensex (Economic Activity)",       "unit": "Index",  "color": "#ff6b6b"},
        "pmi":               {"ticker": "INDA",     "label": "India Manufacturing Proxy",        "unit": "Price $","color": "#6f42c1"},
    },
    "🇹🇷 Turkey": {
        "m2":                {"ticker": "XU100.IS", "label": "BIST 100 (M2 Liquidity Proxy)",   "unit": "Index",  "color": "#00bfff"},
        "employment":        {"ticker": "TUR",      "label": "iShares Turkey ETF",               "unit": "Price $","color": "#28a745"},
        "consumer_spending": {"ticker": "XU100.IS", "label": "BIST Consumer Proxy",              "unit": "Index",  "color": "#fd7e14"},
        "pce_index":         {"ticker": "TRYUSD=X", "label": "TRY/USD Exchange Rate",            "unit": "Rate",   "color": "#dc3545"},
        "inflation":         {"ticker": "XU100.IS", "label": "BIST (Inflation Hedge Proxy)",     "unit": "Index",  "color": "#ff6b6b"},
        "pmi":               {"ticker": "TUR",      "label": "Turkey Manufacturing Proxy",       "unit": "Price $","color": "#6f42c1"},
    },
}

# OECD API for actual economic indicators (free, no API key needed)
OECD_INDICATORS = {
    "🇺🇸 US": {
        "m2":                {"subject": "MANM.M2", "country": "USA", "label": "US M2 Money Supply",           "unit": "Index"},
        "employment":        {"subject": "LRHUTTTT", "country": "USA", "label": "US Unemployment Rate",        "unit": "%"},
        "consumer_spending": {"subject": "CSCICP03", "country": "USA", "label": "US Consumer Confidence",      "unit": "Index"},
        "pce_index":         {"subject": "CPALTT01", "country": "USA", "label": "US CPI All Items",            "unit": "Index"},
        "inflation":         {"subject": "CPALTT01", "country": "USA", "label": "US CPI (Inflation Proxy)",    "unit": "Index"},
        "pmi":               {"subject": "BSCICP03", "country": "USA", "label": "US Business Confidence",      "unit": "Index"},
    },
    "🇩🇪 Germany": {
        "m2":                {"subject": "MANM.M2", "country": "DEU", "label": "Germany M2 Money Supply",      "unit": "Index"},
        "employment":        {"subject": "LRHUTTTT", "country": "DEU", "label": "Germany Unemployment Rate",   "unit": "%"},
        "consumer_spending": {"subject": "CSCICP03", "country": "DEU", "label": "Germany Consumer Confidence", "unit": "Index"},
        "pce_index":         {"subject": "CPALTT01", "country": "DEU", "label": "Germany CPI",                 "unit": "Index"},
        "inflation":         {"subject": "CPALTT01", "country": "DEU", "label": "Germany CPI (Inflation)",     "unit": "Index"},
        "pmi":               {"subject": "BSCICP03", "country": "DEU", "label": "Germany Business Confidence", "unit": "Index"},
    },
    "🇯🇵 Japan": {
        "m2":                {"subject": "MANM.M2", "country": "JPN", "label": "Japan M2 Money Supply",        "unit": "Index"},
        "employment":        {"subject": "LRHUTTTT", "country": "JPN", "label": "Japan Unemployment Rate",     "unit": "%"},
        "consumer_spending": {"subject": "CSCICP03", "country": "JPN", "label": "Japan Consumer Confidence",   "unit": "Index"},
        "pce_index":         {"subject": "CPALTT01", "country": "JPN", "label": "Japan CPI",                   "unit": "Index"},
        "inflation":         {"subject": "CPALTT01", "country": "JPN", "label": "Japan CPI (Inflation)",       "unit": "Index"},
        "pmi":               {"subject": "BSCICP03", "country": "JPN", "label": "Japan Business Confidence",   "unit": "Index"},
    },
    "🇨🇳 China": {
        "m2":                {"subject": "MANM.M2", "country": "CHN", "label": "China M2 Money Supply",        "unit": "Index"},
        "employment":        {"subject": "LRHUTTTT", "country": "CHN", "label": "China Unemployment Rate",     "unit": "%"},
        "consumer_spending": {"subject": "CSCICP03", "country": "CHN", "label": "China Consumer Confidence",   "unit": "Index"},
        "pce_index":         {"subject": "CPALTT01", "country": "CHN", "label": "China CPI",                   "unit": "Index"},
        "inflation":         {"subject": "CPALTT01", "country": "CHN", "label": "China CPI (Inflation)",       "unit": "Index"},
        "pmi":               {"subject": "BSCICP03", "country": "CHN", "label": "China Business Confidence",   "unit": "Index"},
    },
    "🇮🇳 India": {
        "m2":                {"subject": "MANM.M2", "country": "IND", "label": "India M2 Money Supply",        "unit": "Index"},
        "employment":        {"subject": "LRHUTTTT", "country": "IND", "label": "India Unemployment Rate",     "unit": "%"},
        "consumer_spending": {"subject": "CSCICP03", "country": "IND", "label": "India Consumer Confidence",   "unit": "Index"},
        "pce_index":         {"subject": "CPALTT01", "country": "IND", "label": "India CPI",                   "unit": "Index"},
        "inflation":         {"subject": "CPALTT01", "country": "IND", "label": "India CPI (Inflation)",       "unit": "Index"},
        "pmi":               {"subject": "BSCICP03", "country": "IND", "label": "India Business Confidence",   "unit": "Index"},
    },
    "🇹🇷 Turkey": {
        "m2":                {"subject": "MANM.M2", "country": "TUR", "label": "Turkey M2 Money Supply",       "unit": "Index"},
        "employment":        {"subject": "LRHUTTTT", "country": "TUR", "label": "Turkey Unemployment Rate",    "unit": "%"},
        "consumer_spending": {"subject": "CSCICP03", "country": "TUR", "label": "Turkey Consumer Confidence",  "unit": "Index"},
        "pce_index":         {"subject": "CPALTT01", "country": "TUR", "label": "Turkey CPI",                  "unit": "Index"},
        "inflation":         {"subject": "CPALTT01", "country": "TUR", "label": "Turkey CPI (Inflation)",      "unit": "Index"},
        "pmi":               {"subject": "BSCICP03", "country": "TUR", "label": "Turkey Business Confidence",  "unit": "Index"},
    },
}
...
def fetch_yahoo_chart(ticker, period="10y", interval="1wk"):
    """Fetch price data from Yahoo Finance chart API. No extra library needed."""
    try:
...
@st.cache_data(ttl=86400, show_spinner=False)
def fetch_oecd_indicator(subject, country, start_year=2010):
    """
    Fetch economic indicator from OECD Data API (free, no key needed).
    Uses the SDMX-JSON API endpoint.
    Returns DataFrame with date index and 'value' column.
    """
    try:
        # OECD SDMX API v1
        url = f"https://sdmx.oecd.org/public/rest/data/OECD.SDD.SNAS,DSD_NAMAIN10@DF_TABLE5_EXPENDITURE,1.0/{country}.Q....S1..B1GQ..V..?"
        # Try the MEI (Main Economic Indicators) dataset which has unemployment, CPI, confidence
        if subject == "LRHUTTTT":
            url = f"https://stats.oecd.org/sdmx-json/data/MEI/{subject}.{country}.ST.M/all?startTime={start_year}"
        elif subject == "CPALTT01":
            url = f"https://stats.oecd.org/sdmx-json/data/MEI/{subject}.{country}.GY.M/all?startTime={start_year}"
        elif subject in ("CSCICP03", "BSCICP03"):
            url = f"https://stats.oecd.org/sdmx-json/data/MEI/{subject}.{country}.GP.M/all?startTime={start_year}"
        elif "MANM" in subject:
            url = f"https://stats.oecd.org/sdmx-json/data/MEI_FIN/MANM.M2.{country}.ST.M/all?startTime={start_year}"
        else:
            return None
        ...
        if resp.status_code == 200:
            ...
            if datasets:
                ...
                if series:
                    ...
                    if time_dim and observations:
                        rows = []
                        for idx_str, vals in observations.items():
                            idx = int(idx_str)
                            if idx < len(time_dim):
                                date_str = time_dim[idx].get("id", "")
                                val = vals[0] if vals else None
                                if val is not None:
                                    try:
                                        rows.append({"date": pd.to_datetime(date_str), "value": float(val)})
...
def build_global_m2_index():
    """Build a normalized Global M2 index using S&P 500 as liquidity proxy from Yahoo Finance."""
    # S&P 500 is the best freely-available proxy for global liquidity
    m2 = fetch_yahoo_chart("^GSPC", period="10y", interval="1wk")
...
def create_m2_vs_asset_chart(m2_df, asset_df, asset_name, asset_color, lag_weeks=0):
    """Create a dual-axis chart: Global M2 proxy vs an asset with optional lag."""
    ...
    fig.add_trace(go.Scatter(
        ...
        mode='lines', name=f"Global Liquidity{f' (shifted {lag_weeks}w)' if lag_weeks else ''}",
    ...
    lag_text = f" (Liquidity leads by {lag_weeks} weeks)" if lag_weeks else ""
    fig.update_layout(
        title=f"Global Liquidity vs {asset_name}{lag_text}",
        height=350, margin=dict(l=60, r=60, t=40, b=60),
        yaxis=dict(title="Global Liquidity (Indexed)", side="left", showgrid=False),
...
def display_macro_analysis():
    ...
    st.caption("Global liquidity flows and key economic indicators | Data: Yahoo Finance + OECD")
    
    # =====================================================================
    # TOP: Global Liquidity vs BTC, Gold, Silver
    # =====================================================================
    with st.spinner("Loading global liquidity and asset data from Yahoo Finance..."):
    ...
    if m2_df is not None:
        st.markdown("#### 💰 Global Liquidity vs Assets")
        st.caption("S&P 500 used as global liquidity proxy (highly correlated with M2). Bitcoin shown with 10-week lag.")
        ...
        st.warning("⚠️ Could not fetch data from Yahoo Finance. Check your internet connection.")
    ...
    data_source = st.radio(
        "Data source",
        ["📈 Market Proxies (Yahoo Finance)", "📊 Official Statistics (OECD)"],
        horizontal=True, key="macro_source"
    )
    
    indicator_names = {
        "m2": "M2 Money Supply",
        "employment": "Employment / Unemployment",
        "consumer_spending": "Consumer Spending / Confidence",
        "pce_index": "CPI / PCE Index",
        "inflation": "Inflation / Core CPI",
        "pmi": "Manufacturing PMI / Business Confidence",
    }
    
    keys = ["m2", "employment", "consumer_spending", "pce_index", "inflation", "pmi"]
    
    if "Market Proxies" in data_source:
        config = COUNTRY_MACRO_CONFIG[country]
        with st.spinner(f"Loading {country} market data from Yahoo Finance..."):
            indicator_data = {}
            for key, cfg in config.items():
                indicator_data[key] = fetch_yahoo_chart(cfg["ticker"], period="10y", interval="1mo")
        ...
        for row_idx in range(0, len(keys), 2):
            ...
            for ci, col in enumerate([col1, col2]):
                ...
                with col:
                    if df is not None and not df.empty:
                        fig = create_country_indicator_chart(df, cfg["label"], cfg["unit"], cfg.get("color", "#17a2b8"))
                        if fig:
                            st.plotly_chart(fig, use_container_width=True, config=PLOTLY_CONFIG)
        ...
        st.caption("Source: Yahoo Finance | These are market-based proxies — ETFs and indices that track economic conditions")
    
    else:
        # OECD official statistics
        oecd_config = OECD_INDICATORS.get(country, {})
        if not oecd_config:
            st.info("OECD data not configured for this country")
            return
        ...
        with st.spinner(f"Loading {country} data from OECD..."):
            indicator_data = {}
            for key, cfg in oecd_config.items():
                indicator_data[key] = fetch_oecd_indicator(cfg["subject"], cfg["country"])
        
        loaded = sum(1 for k in keys if indicator_data.get(k) is not None)
        if loaded == 0:
            st.warning("Could not load OECD data. The OECD API may be temporarily unavailable. Try 'Market Proxies' instead.")
            ...
            for ci, col in enumerate([col1, col2]):
                ...
                with col:
                    if df is not None and not df.empty:
                        ...
                        st.info(f"{cfg['label']}: Data not available from OECD")
        
        st.caption("Source: OECD Main Economic Indicators (MEI) database | Official government statistics")
